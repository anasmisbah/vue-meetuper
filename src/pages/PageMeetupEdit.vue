    ...
    <section class="hero">
      <div class="hero-body">
        ...
        <div class="is-pulled-right">
          <!-- Update Button -->
          <button @click.prevent="updateMeetupChange"
...
export default {
    ...
    created() {
        this.fetchMeetupDetailHandler()
        this.fetchCategories()
          
    },
    methods: {
        ...mapActions('meetups',['fetchDetailMeetup','updateMeetup']),
        ...mapActions('categories',['fetchCategories']),
        fetchMeetupDetailHandler(){
            this.fetchDetailMeetup(this.meetupId)
            .then(meetup=>{
        ...
        updateMeetupChange(){
            ...
            .then(()=>{
                this.$toasted.success('Meetup successfully Updated',{duration:3000})
            })
        }
    },
}
